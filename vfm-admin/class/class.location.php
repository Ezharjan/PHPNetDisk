...
if (!class_exists('Location', false)) {
    ...
    class Location
    {
        ...
        */
        ...
        {
            $fullpath = (strlen(SetUp::getConfig('basedir')
        ...
        */
        public function editAllowed($relative = false)
        {
            ...
            if (GateKeeper::getUserInfo('dir') == null
                || $this->checkUserDir($relative) == true
            ) {
                return true;
            }
            return false;
        ...
        */
        public function checkUserDir($relative = false)
        {
            ...
            $userpatharray = GateKeeper::getUserInfo('dir') ? json_decode(GateKeeper::getUserInfo('dir'), true) : array();

            foreach ($userpatharray as $value) {
                $userpath = substr($startdir.$value, 2);
                if (strpos($thispath, $userpath) !== false) {
                    return true;
                }
            }
            return false;
