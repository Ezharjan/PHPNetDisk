...
function BasicMP3Player(){var s=this,n=this,t=soundManager,e=navigator.userAgent.match(/ipad|iphone/i),a=navigator.userAgent.match(/msie/i);this.excludeClass="button-exclude",this.links=[],this.sounds=[],this.soundsByURL={},this.indexByURL={},this.lastSound=null,this.soundCount=0,this.config={playNext:!0,autoPlay:!1},this.css={sDefault:"sm2_button",sLoading:"sm2_loading",sPlaying:"sm2_playing",sPaused:"sm2_paused"},this.includeClass=this.css.sDefault,this.addEventHandler="undefined"!=typeof window.addEventListener?function(s,n,t){return s.addEventListener(n,t,!1)}:function(s,n,t){s.attachEvent("on"+n,t)},this.removeEventHandler="undefined"!=typeof window.removeEventListener?function(s,n,t){return s.removeEventListener(n,t,!1)}:function(s,n,t){return s.detachEvent("on"+n,t)},this.classContains=function(s,n){return"undefined"!=typeof s.className?s.className.match(new RegExp("(\\s|^)"+n+"(\\s|$)")):!1},this.addClass=function(n,t){return n&&t&&!s.classContains(n,t)?void(n.className=(n.className?n.className+" ":"")+t):!1},this.removeClass=function(n,t){return n&&t&&s.classContains(n,t)?void(n.className=n.className.replace(new RegExp("( "+t+")|("+t+")","g"),"")):!1},this.getSoundByURL=function(n){return"undefined"!=typeof s.soundsByURL[n]?s.soundsByURL[n]:null},this.isChildOfNode=function(s,n){if(!s||!s.parentNode)return!1;n=n.toLowerCase();do s=s.parentNode;while(s&&s.parentNode&&s.nodeName.toLowerCase()!==n);return s.nodeName.toLowerCase()===n?s:null},this.events={play:function(){n.removeClass(this._data.oLink,this._data.className),this._data.className=n.css.sPlaying,n.addClass(this._data.oLink,this._data.className)},stop:function(){n.removeClass(this._data.oLink,this._data.className),this._data.className=""},pause:function(){n.removeClass(this._data.oLink,this._data.className),this._data.className=n.css.sPaused,n.addClass(this._data.oLink,this._data.className)},resume:function(){n.removeClass(this._data.oLink,this._data.className),this._data.className=n.css.sPlaying,n.addClass(this._data.oLink,this._data.className)},finish:function(){if(n.removeClass(this._data.oLink,this._data.className),this._data.className="",n.config.playNext){var s=n.indexByURL[this._data.oLink.href]+1;s<n.links.length&&n.handleClick({target:n.links[s]})}}},this.stopEvent=function(s){return"undefined"!=typeof s&&"undefined"!=typeof s.preventDefault?s.preventDefault():"undefined"!=typeof window.event&&(window.event.returnValue=!1),!1},this.getTheDamnLink=a?function(s){return s&&s.target?s.target:window.event.srcElement}:function(s){return s.target},this.handleClick=function(n){if("undefined"!=typeof n.button&&n.button>1)return!0;var e,a,i,o=s.getTheDamnLink(n);return"a"===o.nodeName.toLowerCase()||(o=s.isChildOfNode(o,"a"))?(e=o.getAttribute("href"),o.href&&soundManager.canPlayLink(o)&&!s.classContains(o,s.excludeClass)&&s.classContains(o,s.includeClass)?(a=o.href,i=s.getSoundByURL(a),i?i===s.lastSound?i.togglePause():(i.togglePause(),s.lastSound&&s.stopSound(s.lastSound)):(i=t.createSound({id:"basicMP3Sound"+s.soundCount++,url:a,onplay:s.events.play,onstop:s.events.stop,onpause:s.events.pause,onresume:s.events.resume,onfinish:s.events.finish,type:o.type||null}),i._data={oLink:o,className:s.css.sPlaying},s.soundsByURL[a]=i,s.sounds.push(i),s.lastSound&&s.stopSound(s.lastSound),i.play()),s.lastSound=i,s.stopEvent(n)):!0):!0},this.stopSound=function(s){soundManager.stop(s.id),e||soundManager.unload(s.id)},this.init=function(){var n=0,t=$(".sm2_button");$(t).each(function(e,a){s.links[n]=t[e],s.indexByURL[t[e].href]=n,n++}),n>0&&(s.addEventHandler(document,"click",s.handleClick),s.config.autoPlay&&s.handleClick({target:s.links[0],preventDefault:function(){}}))},this.init()}
