...
* http://www.schillmania.com/projects/soundmanager2/demo/mp3-player-button/basic.html
*/
function BasicMP3Player() {
  ...
  this.handleClick = function(e) {
    ...
    if (thisSound) {
      ...
      if (thisSound === self.lastSound) {
        ...
        // console.log('sound different than last sound: '+self.lastSound.id);
        if (self.lastSound) {
  ...
  this.init = function() {
    ...
    foundItems = 0,
    oLinks = $('.sm2_button');
	$(oLinks).each(function(index, item){
		    self.links[foundItems] = (oLinks[index]);
	        self.indexByURL[oLinks[index].href] = foundItems; // hack for indexing
	        foundItems++;
	});
    if (foundItems>0) {
    ...
    // console.log('basicMP3Player.init(): Found '+foundItems+' relevant items.');
  };
  this.init();
}
...
// /**
// *
// * Call SoundManager see /js/pp.js callback for fileTable
// *
// */
