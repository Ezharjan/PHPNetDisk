        ...
        <div class="login">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    action="<?php echo $location->makeLink(false, null, ""); ?>">
                    ...
                    <p><a href="?rp=req"><?php echo $setUp->getString("lost_password"); ?></a></p>
                </div>
            </div>
    <?php
...
if ($gateKeeper->isAccessAllowed() 
    && $gateKeeper->showLoginBox()
        ...
        <section class="vfmblock">
            ...
            action="<?php echo $location->makeLink(false, null, ""); ?>" class="form-inline" role="form">
                <div id="login_bar">
                    <div class="form-group">
                        <label class="sr-only" for="user_name">
                            <?php echo $setUp->getString("username"); ?>:
    ...
    if ($setUp->getConfig("registration_enable") == true ) { ?>
            ...
            <a class="small" href="?rp=req"><?php echo $setUp->getString("lost_password"); ?></a>
        </section>
        <?php
}